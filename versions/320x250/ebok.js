...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function animate () {
      ...
      if (!(items && items.length)) {
        _active = false;
        console.error("not items or not items.length")
        return false;
      }
